...
function mostrarNPC(npc) {
        ...
        <div class="statblock-container">
          ${npc.statblock.dc ? `
            <div class="statblock-line">
              <span class="statblock-label"><strong>CD:</strong></span>
          ...
          <div class="statblock-line">
            ...
            <span class="statblock-value">+${npc.statblock.ataqueRange}, hit: ${npc.statblock.range} (${npc.statblock.ataqueD} pies)</span>
          </div>
        </div>
      `;
    }
    ...
    if (npc.magia && npc.spellsPorDia) {
        let contenidoMagia = "";
        if (npc.magia.trucos?.length) contenidoMagia += `<p><strong>Trucos:</strong> ${npc.magia.trucos.join(", ")}</p>`;
        ...
        if (contenidoMagia) magiaHTML = `<div class="magia-box"><h3>Magia</h3>${contenidoMagia}</div>`;
    }
